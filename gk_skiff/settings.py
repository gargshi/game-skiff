"""
Django settings for gk_skiff project.
...
#SECRET_KEY = 'django-insecure-rce6k3hi3jo#@igpek*&a$nn-h28cz%z$e!n@wuoig(p*d^70p'
...
WSGI_APPLICATION = 'gk_skiff.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / "static",                 # optional for your custom static files
]
